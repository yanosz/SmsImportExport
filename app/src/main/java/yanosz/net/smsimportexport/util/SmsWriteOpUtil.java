...
/**
 * By Mike M.
 * http://stackoverflow.com/questions/27697282/android-kitkat-api-19-how-to-write-messages-in-sms-content-provider-without
 */
...
public final class SmsWriteOpUtil {
    ...
    private static Object checkOp(Context context, int code, int uid) {
        ...
        AppOpsManager appOpsManager =
                (AppOpsManager) context.getSystemService(APP_OPS_SERVICE);
